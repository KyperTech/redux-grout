...
function callGrout(method, schema, callData, model) {
  ...
  if (model) {
    ...
    return grout[model][method](callData).then(function (response) {
    ...
    console.log('calling grout from middleware:');
    return grout[method](callData).then(function (response) {
      console.log('grout responed:', response);
      var camelizedJson = (0, _humps.camelizeKeys)(response);
      return Object.assign({}, (0, _normalizr.normalize)(camelizedJson, schema));
    }, function (err) {
...
exports.default = function (store) {
  return function (next) {
    return function (action) {
      ...
      return callGrout(method, schema, callData, model).then(function (response) {
