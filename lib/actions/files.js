...
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; } // TODO: handle grout methods in actions until final method
...
var CLONE_REPO_REQUEST = exports.CLONE_REPO_REQUEST = 'CLONE_REPO_REQUEST';
var CLONE_REPO_SUCCESS = exports.CLONE_REPO_SUCCESS = 'CLONE_REPO_SUCCESS';
var CLONE_REPO_FAILURE = exports.CLONE_REPO_FAILURE = 'CLONE_REPO_FAILURE';
/**
 ...
 * @param {String} addData.project.owner - Username of owner of project (in url)
 */
function cloneRepo(project, gitUrl) {
  if (!project) {
    console.error({ description: 'Project data is required to add a file.' });
